...
public partial class SearchName : SearchNameBase
{
...
WriteLiteral(" />\n    <title>eDoctor Patient - Find By Name</title>\n    <link");
...
WriteLiteral(" href=\"hybrid:GotoSearch\"");
...
#line 28 "SearchName.cshtml"
                                                                         Write(AppResources.EnterDoctorName);
...
WriteLiteral(" class=\"card-style search-box search-header bg-theme mt-0\"");
...
#line 32 "SearchName.cshtml"
                                                                             , Tuple.Create<string,object,bool> ("", AppResources.Search
...
"nded-l font-14 mt-3 mb-3 ShowMoreBtn\"");

WriteLiteral(" onclick=\"Searchbtn(this)\"");
...
WriteLiteral("></script>\n    <script>function Searchbtn(sender) {\n            $(sender).attr(\'h" +
"ref\', \'hybrid:gotosearchresultsname?DoctorName=\' + $(\'.SearchTxt\').val().replace" +
"(/\\W/g, \"\").trim());\n        }</script>\n</body>\n</html>");
...
public abstract class SearchNameBase
{
