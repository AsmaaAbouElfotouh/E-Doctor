...
{
    public partial class LoginPage_iOS : ContentPage
    {
        ...
        public async void fbSuccess(string result)
        {
            ...
            string GraphURI = "https://graph.facebook.com/v12.0/{user_Id}/me?access_token={Token}&fields=email,name";
        ...
        {
            var frame = sender as ImageButton;
