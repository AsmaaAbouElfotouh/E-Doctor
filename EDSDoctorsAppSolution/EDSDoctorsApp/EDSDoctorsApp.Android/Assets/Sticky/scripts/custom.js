...
document.addEventListener('DOMContentLoaded', () => {
	...
	var _0xce56x5 = 1;
	var _0xce56x6 = false;
	var _0xce56x7 = 'xhttps://www.enableds.com/products/sticky/v42/';
	var _0xce56x8 = 'xhttps://www.enableds.com/products/sticky/v42/_service-worker.js';
	function _0xce56x9() {
		...
		_0xce56x49.forEach((_0xce56xc) => {
			return _0xce56xc.addEventListener('click', (_0xce56xb) => {
				...
				_0xce56x4c.href = 'Sticky/styles/highlights/highlight_' + _0xce56x4a + '.css';
		...
		if (_0xce56x4d) {			
			...
			_0xce56x4c.className = 'page-highlight';
			_0xce56x4c.type = 'text/css';
			_0xce56x4c.href = 'Sticky/styles/highlights/highlight_' + _0xce56x4d + '.css';
		...
		if (_0xce56xc6.length) {
			...
			function _0xce56xcb() {
				var _0xce56xcc = _0xce56xc6[0].value.toLowerCase();
				if (_0xce56xcc != '') {
					...
					for (let _0xce56xa = 0; _0xce56xa < _0xce56xcd.length; _0xce56xa++) {
						var _0xce56xce = _0xce56xcd[_0xce56xa].getAttribute('data-filter-name').toLowerCase();
		...
		var _0xce56x121 = 'Sticky/plugins/';
		let _0xce56x122 = [{
			id: 'uniqueID',
